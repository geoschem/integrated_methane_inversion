...
.. list-table::
   ...
   * - ``Region of interest``
     - The region over which the IMI will optimize mean emissions at up to 0.125°×0.15625° (≈12km\ :sup:`2`) resolution. Specified by rectilinear latitude/longitude bounds or a shapefile. The region of interest can be rectilinear or irregular in shape.
   * - ``Inversion domain``
   ...
   * - ``Emission state vector``
     - The collection of 2D emission elements (up to 0.125°×0.15625° resolution) to be optimized in the inversion. Includes elements within the region of interest and buffer elements.
