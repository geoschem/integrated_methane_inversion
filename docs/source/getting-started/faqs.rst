...
What is the IMI?
~~~~~~~~~~~~~~~~~
* The IMI is an open-source software tool for quantifying methane emissions at up to 0.125°x0.15625° (≈12km\ :sup:`2`) and weekly resolution using satellite observations from the `TROPOspheric Monitoring Instrument <https://www.tropomi.eu/>`_ (TROPOMI), a prior estimate of emissions (e.g., a bottom-up emission inventory), and the `GEOS-Chem chemical transport model <https://geoschem.github.io/index.html>`_.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* No. The IMI gives you total emissions at up to 12x12 km\ :sup:`2` grid resolution, including all sources. However, it scrapes point source observations from other databases to improve the prior estimate (optional) and to put the total emission results in context.
...
What can I get from the IMI that's different from point source data providers (GHGSat, Carbon Mapper, Kayrros, etc.)?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
