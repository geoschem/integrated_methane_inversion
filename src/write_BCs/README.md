...
2. Run `sbatch -p intermediate run_boundary_conditions.sh`.
   - GEOS-Chem will be run first (2.0 x 2.5, GEOS-FP, carbon (CH4 only) simulation, 47 L, daily restart files).
