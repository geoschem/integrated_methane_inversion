#!/bin/bash
#SBATCH -J baseline_jacobian_inversion3
...
if true; then
    ...
    cd ${RUNDIR}/baseline_jacobian_inversion3_${xstr}
    ...
    if is_valid_nc "OutputDir/$LastConcFile"; then
        ...
        ./baseline_jacobian_inversion3_${xstr}.run
...
if [ $retVal -ne 0 ]; then
    ...
    echo "Check the log file in the ${RUNDIR}/baseline_jacobian_inversion3_${xstr} directory for more details."
    exit $retVal
fi
